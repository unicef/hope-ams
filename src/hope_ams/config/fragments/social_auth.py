...
SOCIAL_AUTH_STRATEGY = "hope_ams.social.strategy.AMSSocialStrategy"
SOCIAL_AUTH_SANITIZE_REDIRECTS = False
SOCIAL_AUTH_REDIRECT_IS_HTTPS = env.bool("SOCIAL_AUTH_REDIRECT_IS_HTTPS", default=True)
SOCIAL_AUTH_USERNAME_IS_FULL_EMAIL = True
SOCIAL_AUTH_RAISE_EXCEPTIONS = env.bool("SOCIAL_AUTH_RAISE_EXCEPTIONS", default=False)
...
SOCIAL_AUTH_PIPELINE = (
    ...
    "hope_ams.social.pipeline.save_to_group",
    "hope_ams.social.pipeline.set_superusers",
)
