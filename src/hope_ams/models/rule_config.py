...
def get_rule_config_phases() -> list[tuple[str, str]]:
...
class RuleConfig(models.Model):
    ...
    config = models.JSONField(
        ...
        blank=True,
        default=dict,
        help_text=_("Configuration parameters for this rule"),
    )
    phase = models.CharField(
        verbose_name=_("Phase"),
        max_length=20,
        choices=get_rule_config_phases,
    ...
    created_at = models.DateTimeField(
        ...
        auto_now_add=True,
        help_text=_("When this rule configuration was created"),
    )
    updated_at = models.DateTimeField(
        verbose_name=_("Updated At"),
        auto_now=True,
        help_text=_("When this rule configuration was last updated"),
    )

    class Meta:
        app_label = "hope_ams"
        verbose_name = _("Rule Configuration")
        verbose_name_plural = _("Rule Configurations")
